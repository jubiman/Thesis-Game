            ...
            if i == self.game.player.inventory.selectedslot:
                ...
                if self.animation:
                    self.game.screen.blit(
                        ...
                        (Settings.Game.WIDTH / 2 - 44, Settings.Game.HEIGHT / 2 - 6))
                    animationtimerectbg = pygame.Rect(Settings.Game.WIDTH / 2 - 300 + 80 * i, Settings.Game.HEIGHT - 95, 40, 8)
                    animationtimerect = pygame.Rect(Settings.Game.WIDTH / 2 - 300 + 80 * i, Settings.Game.HEIGHT - 95,
