import pygame
from core.assets.assets import CustomAssets
...
class Healthbar:
	...
	def draw(self):
		...
		self.game.screen.blit(pygame.transform.scale(CustomAssets.getAsset(1).image, (60, 60)), (30, 30))
		...
		self.game.screen.blit(pygame.transform.scale(CustomAssets.getAsset(21).image, (60, 60)), (30, 100))
		...
		self.game.screen.blit(pygame.transform.scale(CustomAssets.getAsset(11).image, (60, 60)), (30, 170))
